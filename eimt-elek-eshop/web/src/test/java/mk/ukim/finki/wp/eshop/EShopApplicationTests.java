...
import mk.ukim.finki.wp.eLek.service.ProductService;
...
class EShopApplicationTests {
    ...
    public void testGetProducts() throws Exception {
        MockHttpServletRequestBuilder productRequest = MockMvcRequestBuilders.get("/lekovi");
    ...
    public void testDeleteProduct() throws Exception {
        ...
        MockHttpServletRequestBuilder productDeleteRequest = MockMvcRequestBuilders
                .delete("/lekovi/delete/" + product.getId());

        this.mockMvc.perform(productDeleteRequest)
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().is3xxRedirection())
                .andExpect(MockMvcResultMatchers.redirectedUrl("/lekovi"));
    }
